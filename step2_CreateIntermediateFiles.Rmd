...
#------------------------------------------------
master_animal_events<-animals%>%
  left_join(solds)%>%
  left_join(deads)

write_rds(master_animal_events, 'Data/IntermediateFiles/master_animal_events.rds')
...
master_animal_lactation_events<-animal_lactations%>%
  left_join(freshs)%>%
  left_join(drys)%>%
  left_join(archives)

write_rds(master_animal_lactation_events, 'Data/IntermediateFiles/master_animal_lactation_events.rds')
...
write_rds(animals2, 'Data/IntermediateFiles/animals2.rds') #this is a Farm specific file, do not include in final
